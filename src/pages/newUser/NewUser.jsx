...
const NewUser= () => {
  ...
  const [name,setName]=useState("");
                ...
                const handleSubmit = (e) =>{
                    ...
                    fetch("http://localhost:8000/api/register",{method:'post',headers:{"Content-Type":"application/json",'Access-Control-Allow-Origin':'*'},
                    body:JSON.stringify({
                        name:name,
                        email:email,
                        password:password,
  ...
  return (
    <div className="newUser">
      ...
      <form className="newUserForm" onSubmit={handleSubmit}>
        ...
        <div className="newUserItem">
        <button className="newUserButton" onClick={notify } type="submit">Create</button>
        <ToastContainer />
        </div> 
      </form>
    </div>
